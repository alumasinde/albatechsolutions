...
$metaDescription = 'The page you requested could not be found. Explore AlbaTech Solutions services, guides or get help with a task.';
...
<section class="not-found-page" aria-labelledby="not-found-title">
    ...
    <div class="error-actions">
        ...
        <a href="/get-help" class="btn btn-secondary">Get Assistance</a>
    </div>
</section>
<?php
